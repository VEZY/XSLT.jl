# This file is a pure copy of EzXML.jl/src/error.jl, as it is very well done,
# under MIT license, and XSLT uses libxml2's error-handling by default.
...
function throw_xml_error()
    if isempty(XML_GLOBAL_ERROR_STACK)
        error("unknown error of libxml2 or libxslt")
